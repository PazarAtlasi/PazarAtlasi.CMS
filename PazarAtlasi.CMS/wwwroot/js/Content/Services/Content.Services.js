...
if (typeof window.ContentServices !== "undefined") {
  console.warn(
    "ContentServices already loaded, skipping redeclaration"
  );
} else {
  const ContentServices = (function () {
     ...
     */
    function getNewSectionItemCard(
      templateId,
      sectionId = 0,
      itemIndex = 0
    ) {
  ...
  // Make ContentServices globally available
  window.ContentServices = ContentServices;
