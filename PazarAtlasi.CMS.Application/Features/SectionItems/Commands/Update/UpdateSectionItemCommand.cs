...
{
    public class UpdateSectionItemCommand : IRequest<UpdateSectionItemCommandResponse>
    {
        ...
        public List<UpdateSectionItemTranslationDto> Translations { get; set; } = new();
    }

    public class UpdateSectionItemTranslationDto
    {
        public int Id { get; set; }
    ...
    public class UpdateSectionItemCommandResponse
    {
